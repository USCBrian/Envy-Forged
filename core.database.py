...
def init_db():
    ...
    wheels = [
        ...
        ('GS2002','Carbon Five','carbon','19-22"','Wide 5-spoke carbon fiber. Aggressive face, ultralight construction.','Carbon Revolution CR-5 / HRE C21'),
        ('GS2003','Carbon Turbine','carbon','19-22"','Turbine-face carbon fiber. The highest visual spec in the lineup.','Koenigsegg / HRE carbon ref'),
    ]
